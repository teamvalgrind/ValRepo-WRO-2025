...
En resumen, la lógica del Desafío Cerrado es un sistema complejo y adaptativo que utiliza la visión artificial para la detección de colores y la toma de decisiones, apoyado por sensores ultrasónicos y una máquina de estados robusta para el control del motor y la dirección. El robot es capaz de avanzar, girar, retroceder y corregir su trayectoria de manera autónoma, reaccionando a los estímulos del entorno y ejecutando con precisión las acciones necesarias para completar el reto de la WRO 2025.
